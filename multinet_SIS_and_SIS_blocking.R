...
experimentFolder<- "SIR&SIS-blocking_AUCS"
dir.create(experimentFolder) 
directory <- "ModelForPoland"
#folder dla eksperymentów 
setwd(paste("C:/Users/Paulina/Desktop/Repository/", experimentFolder, sep=""))
dir.create(directory)
setwd(paste(paste("C:/Users/Paulina/Desktop/Repository/",experimentFolder,sep=""), directory,sep="/"))
getwd()
