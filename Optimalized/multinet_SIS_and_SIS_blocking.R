...
{
	#net <- ml_aucs()
  net <-read_ml(paste("C:/Users/Paulina/Downloads/FullNet/",networkFileName,sep=""), name=networkName, sep=',', aligned=FALSE)
	...
	{  
	  ...
	  if(i>blockingTime)
		 { #Pêtla dla SIS
		  ...
		  {
			if(get_values_ml(net,"state",networkActors[actualInfectedInNetwork[k]]) =="I")
			{ 
