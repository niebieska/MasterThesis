...
networkName <- "MoscowAthletics2013-MT" #c("Lazega-blocking","AUCS", "MoscowAthletics2013","EU")
...
setwd("C:/Users/Paulina/Desktop/Eksperymenty/Plots/")

write.table(results_percents,file=paste("results_SIR",(paste(paste(paste(scritpType,networkName, sep=""),paste(mainDirectory, w, sep="-"), sep = "-"),".dat", sep = "")), sep="-"), col.names =TRUE, sep =";", row.names = TRUE )
